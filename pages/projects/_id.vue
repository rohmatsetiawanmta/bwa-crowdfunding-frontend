                ...
                <div class="w-1/4">
                    <div class="bg-white w-full p-5 border border-gray-400 rounded-20 sticky" style="top: 15px">
                        ...
                        <nuxt-link to="/fund-success"
                            class="text-center mt-3 button-cta block bg-second-color hover:bg-primary-color border border-second-color hover:border-white text-black hover:text-second-color font-medium px-6 py-3 text-md rounded-full transition duration-300 ease-out hover:ease-in">
                            Fund Now
                        </nuxt-link>
                    </div>
                </div>
                ...
                <div class="w-full md:w-3/4 mr-6">
                    ...
                    <div class="relative progress-bar">
                        <div class="overflow-hidden mb-4 text-xs flex rounded-full bg-gray-200 h-6">
                            <div style="width: 80%"
                                class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-primary-color progress-striped">
                            </div>
                        </div>
                    </div>
